...
const {
  ...
  createSuccess,
  runWithFallback,
} = require("../dist/providers/base.js");
...
describe("providers/base", () => {
  ...
  describe("runWithFallback", () => {
    ...
    it("should handle timeout", async () => {
      ...
      const http = require("../dist/providers/http.js");
      const originalPostJson = http.postJson;
      http.postJson = mockPostJson;
      ...
      http.postJson = originalPostJson;
